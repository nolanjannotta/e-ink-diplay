...
dayFont = ImageFont.truetype(os.path.join(fontdir, 'LinLibertine-Bold-Regular.ttf'),size=60)
weatherFont = ImageFont.truetype(os.path.join(fontdir, 'LinLibertine-Bold-Regular.ttf'),size=40)
